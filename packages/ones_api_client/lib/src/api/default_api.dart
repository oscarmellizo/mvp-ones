...
class DefaultApi {
  ...
  Future<Response<AcceptEventCoverResponse>> acceptEventCover({ 
    ...
    AcceptEventCoverResponse? _responseData;
    ...
    return Response<AcceptEventCoverResponse>(
      data: _responseData,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteTranslation({ 
    ...
    final _path = r'/v1/admin/translations/{translationKey}/{languageCode}'.replaceAll('{' r'translationKey' '}', encodeQueryParameter(_serializers, translationKey, const FullType(String)).toString()).replaceAll('{' r'languageCode' '}', encodeQueryParameter(_serializers, languageCode, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> evictTranslationsCache({ 
    String? languageCode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/admin/translations/cache/evict';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (languageCode != null) r'languageCode': encodeQueryParameter(_serializers, languageCode, const FullType(String)),
    };
  ...
  Future<Response<GenerateEventCoverResponse>> generateEventCover({ 
    ...
    final _path = r'/v1/events/covers/generate';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    GenerateEventCoverResponse? _responseData;
    ...
    return Response<GenerateEventCoverResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<PresignedUrlResponse>> getEventCoverUrl({ 
    ...
    PresignedUrlResponse? _responseData;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Translation>> getTranslation({ 
    required String translationKey,
    required String languageCode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(Translation),
      ) as Translation;
  ...
  Future<Response<BuiltList<Guest>>> inviteEventGuests({ 
    ...
    return Response<BuiltList<Guest>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Translation>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Translation>>> listTranslations({ 
    String? languageCode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/admin/translations';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    BuiltList<Translation>? _responseData;
    ...
    return Response<BuiltList<Translation>>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [PresignEventCoverUploadResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PresignEventCoverUploadResponse>> presignEventCoverUpload({ 
    required String id,
    required PresignEventCoverUploadRequest presignEventCoverUploadRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/events/{id}/cover/uploads:presign'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(PresignEventCoverUploadRequest);
      _bodyData = _serializers.serialize(presignEventCoverUploadRequest, specifiedType: _type);
    ...
    PresignEventCoverUploadResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PresignEventCoverUploadResponse),
      ) as PresignEventCoverUploadResponse;
    ...
    return Response<PresignEventCoverUploadResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [RefreshTranslationsCacheResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<RefreshTranslationsCacheResponse>> refreshTranslationsCache({ 
    String? languageCode,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/v1/admin/translations/cache/refresh';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    RefreshTranslationsCacheResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(RefreshTranslationsCacheResponse),
      ) as RefreshTranslationsCacheResponse;
    ...
    return Response<RefreshTranslationsCacheResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [PresignedUrlResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PresignedUrlResponse>> setEventCover({ 
    required String id,
    required SetEventCoverRequest setEventCoverRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/v1/events/{id}/cover'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(SetEventCoverRequest);
      _bodyData = _serializers.serialize(setEventCoverRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [Translation] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Translation>> upsertTranslation({ 
    required UpsertTranslationRequest upsertTranslationRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpsertTranslationRequest);
      _bodyData = _serializers.serialize(upsertTranslationRequest, specifiedType: _type);
